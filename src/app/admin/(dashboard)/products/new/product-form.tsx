                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input name="seoTitle_tr" className="w-full border rounded-lg px-4 py-2 bg-white text-gray-900 placeholder-gray-400" placeholder="Örn: Osmanlı Modeli Taş Duvar" />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">SEO Title (EN)</label>
                                <input name="seoTitle_en" className="w-full border rounded-lg px-4 py-2 bg-white text-gray-900 placeholder-gray-400" placeholder="Ex: Ottoman Model Stone Wall" />
                            </div>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">SEO Açıklaması (TR)</label>
                                <textarea name="seoDescription_tr" rows={3} className="w-full border rounded-lg px-4 py-2 bg-white text-gray-900 placeholder-gray-400" placeholder="Google'da görünecek Türkçe açıklama" />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">SEO Description (EN)</label>
                                <textarea name="seoDescription_en" rows={3} className="w-full border rounded-lg px-4 py-2 bg-white text-gray-900 placeholder-gray-400" placeholder="English description for search engines" />
                            </div>
                        </div>
                    </div>
                </div>
