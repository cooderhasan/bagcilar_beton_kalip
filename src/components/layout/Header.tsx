                ...
                <div className="container mx-auto px-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {/* X (Twitter) */}
                            {settings?.twitter && (
                                <a href={settings.twitter} target="_blank" rel="noopener noreferrer" className="w-7 h-7 rounded bg-white/10 hover:bg-orange-500 flex items-center justify-center transition-colors text-white">
                                    <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                                </a>
                            )}
                            {/* YouTube */}
                            {settings?.youtube && (
                                <a href={settings.youtube} target="_blank" rel="noopener noreferrer" className="w-7 h-7 rounded bg-white/10 hover:bg-orange-500 flex items-center justify-center transition-colors text-white">
